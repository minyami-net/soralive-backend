...
class Core{
	...
	static public function showError($e){
		header("X-Powered-By: FeelyFramework/2.0", true, 500);

		if(is_string($e)){
			echo '<html><head><title>发生了错误</title><style>body{font-family: "微软雅黑";}</style></head><body><h2>Error:</h2><h3>'.$e.'</h3><hr><p>FeelyBlog 2.0 Framework</p></body></html>';
			exit();
		}
